...
type Coordinator struct {
	...
	configHashMetric        promshim.Gauge
	configSuccessMetric     promshim.Gauge
	configSuccessTimeMetric promshim.Gauge
}
...
// `Reload()`.
func NewCoordinator(configFilePath string, r promshim.Registerer, l *slog.Logger) *Coordinator {
	c := &Coordinator{
...
func (c *Coordinator) registerMetrics(r promshim.Registerer) {
	configHash := promshim.With(r).NewGauge(promshim.GaugeOpts{
		Name: "alertmanager_config_hash",
		Help: "Hash of the currently loaded alertmanager configuration. Note that this is not a cryptographically strong hash.",
	})
	configSuccess := promshim.With(r).NewGauge(promshim.GaugeOpts{
		Name: "alertmanager_config_last_reload_successful",
		Help: "Whether the last configuration reload attempt was successful.",
	})
	configSuccessTime := promshim.With(r).NewGauge(promshim.GaugeOpts{
