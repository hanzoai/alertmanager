...
func NewMarker(r promshim.Registerer) *MemMarker {
	m := &MemMarker{
...
func (m *MemMarker) registerMetrics(r promshim.Registerer) {
	newMarkedAlertMetricByState := func(st AlertState) promshim.GaugeFunc {
		return promshim.NewGaugeFunc(
			promshim.GaugeOpts{
