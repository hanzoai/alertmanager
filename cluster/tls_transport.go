...
type TLSTransport struct {
	...
	packetsSent promshim.Counter
	packetsRcvd promshim.Counter
	streamsSent promshim.Counter
	streamsRcvd promshim.Counter
	readErrs    promshim.Counter
	writeErrs   *promshim.CounterVec
}
...
func (t *TLSTransport) registerMetrics(reg promshim.Registerer) {
	t.packetsSent = promshim.With(reg).NewCounter(
	...
	t.packetsRcvd = promshim.With(reg).NewCounter(
		promshim.CounterOpts{
			Namespace: metricNamespace,
			Subsystem: metricSubsystem,
	...
	t.streamsSent = promshim.With(reg).NewCounter(
		promshim.CounterOpts{
			Namespace: metricNamespace,
			Subsystem: metricSubsystem,
	...
	t.streamsRcvd = promshim.With(reg).NewCounter(
		promshim.CounterOpts{
			Namespace: metricNamespace,
			Subsystem: metricSubsystem,
	...
	t.readErrs = promshim.With(reg).NewCounter(
		promshim.CounterOpts{
			Namespace: metricNamespace,
			Subsystem: metricSubsystem,
	...
	t.writeErrs = promshim.With(reg).NewCounterVec(
		promshim.CounterOpts{
			Namespace: metricNamespace,
			Subsystem: metricSubsystem,
